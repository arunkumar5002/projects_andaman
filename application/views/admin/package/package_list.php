                ...
                <table class="table table-hover">
                    <thead class="table-dark">
                        <tr>
							...
							<th class="text-white">Package Cost</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="dropdown">
										...
										<a class="dropdown-item text-primary" href="<?php echo base_url('package/package_active/' . $row->id) ?>"><i class="bx bx-edit-alt me-1"></i> Addplan</a>
